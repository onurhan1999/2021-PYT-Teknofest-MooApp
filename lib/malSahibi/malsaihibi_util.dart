...
class CustomColors {
  ...
  static const Color GreenDark = Color.fromRGBO(2, 69, 10, 1.0);
  static const Color GreenLight = Color.fromRGBO(24, 99, 33, 1.0);
  ...
  static const Color HeaderBlueLight = Color.fromRGBO(158, 212, 166, 1.0);
  static const Color HeaderBlueDark = Color.fromRGBO(14, 92, 28, 1.0);
  ...
  static const Color BellGrey = Color.fromRGBO(164, 222, 171, 1.0);
  ...
  static const Color HeaderCircle = Color.fromRGBO(
      91, 156, 126, 0.49411764705882355);
}