...
class milkStatusList extends StatefulWidget {
  @override
  _milkStatusListState createState() => _milkStatusListState();
}
...
class _milkStatusListState extends State<milkStatusList> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: milkAppBar(context),
        body: StreamBuilder<QuerySnapshot>(

          stream: _statusService.getMilkStatus(authMalSahibiGetter(mailDenemeler)),
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          onTap: () {
                                            ...
                                            FirebaseFirestore.instance.collection('Tüm Hayvanlar').doc(mypost['Küpe No']).update({'Süt Durumu': 'Hayır'});
