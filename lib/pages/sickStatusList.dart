...
class sickStatusList extends StatefulWidget {
  @override
  _sickStatusListState createState() => _sickStatusListState();
}
String mailDenemeler='';


class _sickStatusListState extends State<sickStatusList> {
  ...
  Widget build(BuildContext context) {
    ...
    return  MaterialApp(
      ...
      home : Scaffold(
        appBar: sickAppBar(context),

        body: StreamBuilder<QuerySnapshot>(
          stream: _statusService.getSickStatus(authMalSahibiGetter(mailDenemeler)),
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          onTap: () {
                                            ...
                                            FirebaseFirestore.instance.collection('Tüm Hayvanlar').doc(mypost['Küpe No']).update({'Hastalık Durumu': 'Hayır'});
